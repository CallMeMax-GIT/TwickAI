...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:twickbackend_server/src/generated/task_category.dart' as _i5;
import 'package:twickbackend_server/src/generated/task.dart' as _i6;
import 'package:twickbackend_server/src/generated/user_settings.dart' as _i7;
import 'package:twickbackend_server/src/generated/greetings/greeting.dart'
    as _i8;
import 'package:twickbackend_server/src/generated/protocol.dart';
import 'package:twickbackend_server/src/generated/endpoints.dart';
...
class _CategoryEndpoint {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i5.TaskCategory>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i5.TaskCategory> saveCategory(
    _i1.TestSessionBuilder sessionBuilder,
    _i5.TaskCategory category,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i5.TaskCategory>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'categories': categories}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
...
class _TaskEndpoint {
  ...
  _i3.Future<List<_i6.Task>> saveTasks(
    _i1.TestSessionBuilder sessionBuilder,
    List<_i6.Task> tasks,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
...
class _UserSettingsEndpoint {
  ...
  _i3.Future<_i7.UserSettings> saveSettings(
    _i1.TestSessionBuilder sessionBuilder,
  ...
  _i3.Future<void> deleteSettings(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'userSettings',
