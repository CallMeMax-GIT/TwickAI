...
CREATE TABLE IF NOT EXISTS "task" (
    ...
    "recurringDuration" bigint NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS "task_auth_user_client_id_idx" ON "task" USING btree ("authUserId", "clientId");

--
-- Class TaskCategory as table task_category
--
...
CREATE UNIQUE INDEX IF NOT EXISTS "task_category_auth_user_client_id_idx" ON "task_category" USING btree ("authUserId", "clientId");
...
CREATE TABLE IF NOT EXISTS "user_settings" (
    ...
    "sleepModeFromHour" bigint NOT NULL,
    "sleepModeFromMinute" bigint NOT NULL,
    "sleepModeToHour" bigint NOT NULL,
    "sleepModeToMinute" bigint NOT NULL,
    "createdAt" timestamp without time zone NOT NULL,
    "updatedAt" timestamp without time zone NOT NULL
);

-- Indexes
CREATE UNIQUE INDEX IF NOT EXISTS "user_settings_auth_user_id_idx" ON "user_settings" USING btree ("authUserId");
...
--
CREATE TABLE IF NOT EXISTS "serverpod_auth_idp_firebase_account" (
    "id" uuid PRIMARY KEY DEFAULT gen_random_uuid_v7(),
    "authUserId" uuid NOT NULL,
...
-- Indexes
CREATE UNIQUE INDEX IF NOT EXISTS "serverpod_auth_firebase_account_user_identifier" ON "serverpod_auth_idp_firebase_account" USING btree ("userIdentifier");
...
-- Indexes
CREATE INDEX IF NOT EXISTS "serverpod_auth_idp_rate_limited_request_attempt_composite" ON "serverpod_auth_idp_rate_limited_request_attempt" USING btree ("domain", "source", "nonce", "attemptedAt");
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_log_fk_0') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_message_log_fk_0') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_query_log_fk_0') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_auth_idp_apple_account_fk_0') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_auth_idp_email_account_fk_0') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_auth_idp_email_account_password_reset_request_fk_0') THEN
        ALTER TABLE ONLY "serverpod_auth_idp_email_account_password_reset_request"
            ...
            ON UPDATE NO ACTION;
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_auth_idp_email_account_password_reset_request_fk_1') THEN
        ALTER TABLE ONLY "serverpod_auth_idp_email_account_password_reset_request"
            ...
            ON UPDATE NO ACTION;
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_auth_idp_email_account_password_reset_request_fk_2') THEN
        ALTER TABLE ONLY "serverpod_auth_idp_email_account_password_reset_request"
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_auth_idp_email_account_request_fk_0') THEN
        ALTER TABLE ONLY "serverpod_auth_idp_email_account_request"
            ...
            ON UPDATE NO ACTION;
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_auth_idp_email_account_request_fk_1') THEN
        ALTER TABLE ONLY "serverpod_auth_idp_email_account_request"
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_auth_idp_firebase_account_fk_0') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_auth_idp_google_account_fk_0') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_auth_idp_passkey_account_fk_0') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_auth_core_jwt_refresh_token_fk_0') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_auth_core_profile_fk_0') THEN
        ALTER TABLE ONLY "serverpod_auth_core_profile"
            ...
            ON UPDATE NO ACTION;
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_auth_core_profile_fk_1') THEN
        ALTER TABLE ONLY "serverpod_auth_core_profile"
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_auth_core_profile_image_fk_0') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'serverpod_auth_core_session_fk_0') THEN
...
--
-- MIGRATION VERSION FOR twickbackend
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('twickbackend', '20260127183302418', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260127183302418', "timestamp" = now();
