...
import 'task_category.dart' as _i4;
import 'user_settings.dart' as _i5;
import 'package:twickbackend_client/src/protocol/task_category.dart' as _i6;
import 'package:twickbackend_client/src/protocol/task.dart' as _i7;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.TaskCategory) {
      return _i4.TaskCategory.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i4.TaskCategory?>()) {
      return (data != null ? _i4.TaskCategory.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i5.UserSettings?>()) {
      return (data != null ? _i5.UserSettings.fromJson(data) : null) as T;
    }
    if (t == List<_i6.TaskCategory>) {
      return (data as List)
              .map((e) => deserialize<_i6.TaskCategory>(e))
              .toList()
          as T;
    }
    if (t == List<_i7.Task>) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'TaskCategory') {
      return deserialize<_i4.TaskCategory>(data['data']);
    }
